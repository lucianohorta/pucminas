...
const ProductDetails = () => {
  ...
  const singleProductItem = productData.find((item) => item.carName === slug);
  ...
  return (
    <Helmet title={singleProductItem.carName}>
      <section>
        <Container>
          <Row>
            <Col lg="6">
            ...
            <Col lg="6">
              <div className="car__info">
                <h2 className="section__title">{singleProductItem.carName}</h2>

                <div className=" d-flex align-items-center gap-5 mb-4 mt-3">
                  <h6 className="rent__price fw-bold fs-4">
                    ${singleProductItem.price}.00 / Day
                  </h6>
            ...
            <Col lg="7" className="mt-5">
              <div className="booking-info mt-5">
                <h5 className="mb-4 fw-bold ">Informações para locação</h5>
                <BookingForm />
              </div>
            </Col>
